...
- Name: device-machine-mode.spec.ts >> mqtt scan with machine_active updates toggle button via sse
- Location: src/tests/e2e/device-machine-mode.spec.ts:112:5
...
Call log:
  - Expect "toHaveURL" with timeout 10000ms
    - waiting for "http://localhost:4173/auth/google" navigation to finish...
    - navigated to "http://localhost:4173/auth/google"
