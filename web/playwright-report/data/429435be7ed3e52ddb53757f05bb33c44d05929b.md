...
- Name: device-machine-mode.spec.ts >> clicking turn on activates machine and shows turn off button
- Location: src/tests/e2e/device-machine-mode.spec.ts:24:1
...
Locator: locator('button:has-text("Turn Off")')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Turn Off")')
