...
test('scan event: denied NFC scan appears in history and last-unauthorized panel', async ({ page }) => {
    ...
    await expect(page.locator('h2:has-text("Last Unauthorized Scan")')).toBeVisible({ timeout: 10_000 });
