    ...
    <>
      <header className="fixed top-0 right-0 left-0 z-50 border-b border-separator-secondary bg-background-primary/80 backdrop-blur-lg">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <a href="/" className="font-display text-xl font-bold tracking-tight text-label-primary">
            prismo
          </a>
      ...
      <section className="relative overflow-hidden pt-32 pb-20">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-separator-secondary bg-fill-tertiary px-4 py-1.5">
            ...
            <span className="font-display text-xs font-bold tracking-wide text-label-secondary uppercase">
              Pre-release — In Active Development
            </span>
          </div>

          <h1 className="mb-6 font-display text-4xl leading-tight font-bold tracking-tight text-label-primary md:text-6xl md:leading-tight">
      ...
      <section id="features" className="py-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-14 text-center">
            <h2 className="mb-4 font-display text-3xl font-bold tracking-tight text-label-primary md:text-4xl">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <div className="rounded-3xl border border-separator-secondary bg-fill-tertiary p-12 md:p-16">
            <Icon icon="mdi:open-source-initiative" className="mx-auto mb-6 h-12 w-12 text-label-primary" />
            <h2 className="mb-4 font-display text-3xl font-bold tracking-tight text-label-primary md:text-4xl">
              Join the project
            </h2>
      ...
      <footer className="border-t border-separator-secondary py-8">
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <span className="font-display text-sm font-bold text-label-tertiary"> prismo </span>
            <div className="flex items-center gap-6">
              <a
                href={githubUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-label-tertiary transition-colors hover:text-label-primary"
              >
                GitHub
              </a>
              <a
